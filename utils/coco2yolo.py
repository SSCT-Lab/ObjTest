...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_path', type=str, help="input: coco format(json)", required=True)
    parser.add_argument('--save_path', type=str, help="specify where to save the output dir of labels", required=True)
